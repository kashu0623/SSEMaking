...
# Refine the two near-tied round2 ridges across Light, Deep alpha, and Deep gain.
...
WAKE_ALPHAS="${WAKE_ALPHAS:-0.25,0.275,0.30,0.325,0.35}"
LIGHT_ALPHAS="${LIGHT_ALPHAS:-0.16,0.18,0.20,0.22,0.24,0.26,0.28,0.30,0.34}"
DEEP_ALPHAS="${DEEP_ALPHAS:-0.80,0.85,0.90,0.925,0.95,0.975,1.00}"
REM_ALPHAS="${REM_ALPHAS:-0.00}"
DEEP_GAINS="${DEEP_GAINS:-1.15,1.20,1.25,1.30,1.35,1.40,1.45}"
...
summary_json="${OUTPUT_ROOT}/fusion4_same_split_ensemble_plus_direct4_original_hybrid_deep_refine_round3_context${CONTEXT_EPOCHS}_h${HIDDEN_SIZE}_summary.json"
...
echo "=== Direct4 hybrid Deep refinement round3 complete: ${summary_json} ==="
