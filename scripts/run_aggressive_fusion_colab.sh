...
FUSION_REPORT_SUFFIX="${FUSION_REPORT_SUFFIX}" \
TWO_CLASSWISE_NON_REM_ALPHAS="${TWO_CLASSWISE_NON_REM_ALPHAS}" \
TWO_CLASSWISE_REM_ALPHAS="${TWO_CLASSWISE_REM_ALPHAS}" \
THREE_NON_REM_PRIMARY_ALPHAS="${THREE_NON_REM_PRIMARY_ALPHAS}" \
THREE_NON_REM_SECONDARY_ALPHAS="${THREE_NON_REM_SECONDARY_ALPHAS}" \
